/**
 * Solana Actions — Transfer SOL (official pattern)
 * Source: https://github.com/solana-developers/solana-actions/blob/main/examples/next-js/src/app/api/actions/transfer-sol/route.ts
 *
 * Copy to: src/app/api/actions/transfer-sol/route.ts
 * Copy const to: src/app/api/actions/transfer-sol/const.ts
 */
...
export const GET = async (req: Request) => {
  try {
    ...
    const payload: ActionGetResponse = {
      type: "action",
      title: "Tip Jar — Transfer SOL",
      icon: new URL("/icon.png", requestUrl.origin).toString(),
      description: "Send SOL to support this project on Solana.",
      label: "Transfer",
      links: {
        actions: [
